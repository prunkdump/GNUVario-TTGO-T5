...
//	ScreenDigit tensionDigit(TENSION_DISPLAY_POSX /*VARIOSCREEN_TENSION_ANCHOR_X*/, VARIOSCREEN_TENSION_ANCHOR_Y, 5, 2, false, false, ALIGNRIGHT);
	...
	//displayList  = new ScreenSchedulerObject[2];
	MaxObjectList = 0;
	...
	CreateObjectDisplay(DISPLAY_OBJECT_TENSION, tensionDigit, 0, 1, true); 
	...
	schedulerScreen = new ScreenScheduler(displayList, ITEMS_IN_ARRAY(displayList), 0, 0);
