...
#define VARIOSCREEN_SPEED_ANCHOR_X 52
...
/*	tensionDigit = new ScreenDigit(VARIOSCREEN_TENSION_ANCHOR_X, VARIOSCREEN_TENSION_ANCHOR_Y, 5, 2, false, false, ALIGNRIGHT);	
	...
	timeMDigit = new ScreenDigit (VARIOSCREEN_TIME_ANCHOR_X, VARIOSCREEN_TIME_ANCHOR_Y, 2, 0, false, true, ALIGNRIGHT);
	timeHDigit = new ScreenDigit (VARIOSCREEN_TIME_ANCHOR_X-68, VARIOSCREEN_TIME_ANCHOR_Y, 2, 0, false, true, ALIGNRIGHT);
...
//****************************************************************************************************************************
  stateDisplay = STATE_BUSY;
	...
	display.display(false); //true); // partial update
  stateDisplay = STATE_OK;
  vTaskDelete(NULL);
}
...
*/
  ...
  uVoltage = (VOLTAGE_DIVISOR_REF_VOLTAGE / VOLTAGE_RESOLUTION) * voltage * VOLTAGE_DIVISOR_VALUE;
...
//****************************************************************************************************************************
  ...
  if (newTime > 999999) newTime = newTime / 10;
