...
class SpeedFlightHistory : public FlightHistory<period, count> {
 ...
 SpeedFlightHistory(void) : speedValuesPos(0) { }
  double getGlideRatio(double speed, unsigned long timestamp, int8_t periodCount = count);
...
template<unsigned period, int8_t count, int8_t speedPeriodCount>
double SpeedFlightHistory<period, count, speedPeriodCount>::getGlideRatio(double speed, unsigned long timestamp, int8_t periodCount) {
