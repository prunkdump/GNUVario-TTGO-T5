...
#ifndef _GxGDEP015OC1NL_H_
#define _GxGDEP015OC1NL_H_
...
class GxGDEP015OC1 : public GxEPD
{
  public:
    ...
    void updateWindowNL(uint16_t x, uint16_t y, uint16_t w, uint16_t h, bool using_rotation = true);
  ...
  private:
    ...
    void _waitWhileBusy2(const char* comment = 0);
