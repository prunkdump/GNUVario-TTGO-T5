...
#ifndef _GxEPD2_154U_H_
#define _GxEPD2_154U_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_154U : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    // constructor
    GxEPD2_154U(int8_t cs, int8_t dc, int8_t rst, int8_t busy);
    // methods (virtual)
    ...
    void hibernate(); // turns powerOff() and sets controller to deep sleep for minimum power use, ONLY if wakeable by RST (rst >= 0)
		void reset();
    void refreshNB(bool partial_update_mode = false); // screen refresh from controller memory to full screen
