...
uint8_t LxnavSentence::get(void)
{
  ...
  else
  {
    ...
    if (tagPos == LXNAV_SENTENCE_VARIO_POS1)
    {
      valueDigit.begin(vario, LXNAV_SENTENCE_VARIO_PRECISION);
      tagPos++;
    }
    else if (tagPos == LXNAV_SENTENCE_VARIO_POS2)
    {
      valueDigit.begin(vario, LXNAV_SENTENCE_VARIO_PRECISION);
      tagPos++;
    }
    else if (tagPos == LXNAV_SENTENCE_VARIO_POS3)
    {
      valueDigit.begin(vario, LXNAV_SENTENCE_VARIO_PRECISION);
      tagPos++;
    }
    else if (tagPos == LXNAV_SENTENCE_VARIO_POS4)
    {
      valueDigit.begin(vario, LXNAV_SENTENCE_VARIO_PRECISION);
      tagPos++;
    }
    else if (tagPos == LXNAV_SENTENCE_VARIO_POS5)
    {
      valueDigit.begin(vario, LXNAV_SENTENCE_VARIO_PRECISION);
      tagPos++;
    }
    else if (tagPos == LXNAV_SENTENCE_VARIO_POS6)
    {
      valueDigit.begin(vario, LXNAV_SENTENCE_VARIO_PRECISION);
      tagPos++;
    }
